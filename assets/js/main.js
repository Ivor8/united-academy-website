...
(function() {
    ...
    const i18n = {
        en: {
            ...
            council_subtitle: "The governing body ensuring academic excellence and strategic direction",
            council_president: "President of the Council",
            council_president_name: "Dr. Jean-Paul Mbarga",
            council_president_desc: "Former Director of Vocational Training, MINEFOP",
            council_academic: "Academic Advisor",
            council_academic_name: "Prof. Marie-Claire Ngo",
            council_academic_desc: "PhD in Educational Sciences, University of Yaoundé I",
            council_industry: "Industry Representative",
            council_industry_name: "Mr. Alain Djoumessi",
            council_industry_desc: "CEO, Cameroon Employers' Association (GICAM)",
            council_parent: "Parent Representative",
            council_parent_name: "Mme. Thérèse Essama",
            council_parent_desc: "Advocate for student welfare and community engagement",
            council_mission: "Le Conseil d'Établissement oversees the strategic direction, ensures quality assurance, and maintains the alignment of our programs with national vocational training standards. The council meets quarterly to review academic performance, approve new programs, and strengthen partnerships with industry stakeholders.",
