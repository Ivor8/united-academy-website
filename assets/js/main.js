...
(function() {
    ...
    const i18n = {
        en: {
            ...
            index_about_p2: "Our mission: deliver certified qualifications (DQP/CQP) with a 100% success rate, thanks to expert trainers and modern facilities. We are <em>the school of multiple talents</em> - rooted in Cameroonian values and global standards.",
            why_accredited_desc: "Official recognition ensures your certification is nationally valid.",
            why_experts_desc: "Learn from industry professionals with real-world experience.",
            why_jobs_desc: "98% employment rate through our extensive partner network.",
            why_facilities_desc: "Fully equipped labs, computer rooms, and learning resources.",
            why_certification_desc: "100% success rate in national DQP/CQP examinations.",
            why_global_desc: "Curriculum aligned with international best practices.",
        ...
        fr: {
            ...
            why_facilities_desc: "Laboratoires entièrement équipés, salles informatiques et ressources d'apprentissage.",
            why_certification_desc: "Taux de réussite de 100% aux examens nationaux DQP/CQP.",
            why_global_desc: "Programme aligné sur les meilleures pratiques internationales.",
            council_title: "Le Conseil d'Établissement",
